...
runnは標準的なexpr-lang関数に加えて、テストシナリオを便利にする独自のビルトイン関数を提供しています。これらの関数を使用することで、複雑なテストシナリオもシンプルに記述できます。
...
runnのビルトイン関数は、これらの課題をシンプルな関数呼び出しで解決します。
...
runnのビルトイン関数を使いこなすことで：

- テストの記述時間が短縮される
- 差分が見やすくなりバグの発見が容易になる
- テストデータ作成が自動化される
- メンテナンスが容易になる

これらの関数を活用して、効率的なテストを作成しましょう。
