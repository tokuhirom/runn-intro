...
```yaml
{{ includex("examples/chapter01/intro/http-example.yml") }}
```
...
> **おめでとうございます！**
> 
> この章を読み終えたあなたは、もう立派な**runnユーザー**です！
...
✅ **基本コマンド**をマスターした  
✅ **実際にシナリオを書いて実行**できた  
✅ **CLIとGoヘルパーの使い分け**を習得した

### 次のステップへの期待

第1章では基礎を固めました。でも、**これはまだ序章に過ぎません！**

次章では、より高度なシナリオ記述テクニックを学びます：
- **条件分岐**でスマートなテスト
- **ループ処理**で効率的な検証
- **外部ファイル読み込み**で大規模データ対応
- そして**もっと多くの魔法**が...

**準備はいいですか？**

[第2章：シナリオ記述編へ進む →](chapter02.md)
